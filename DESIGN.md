...
A footer component – at the bottom of every page
A photo component
A photo gallery component using the photo component
An info component, this component could be adjusted to be used for both the leadership team information section and the about our club section
...
A Members List component, displaying all of the members
An Add Member component, to add a new member
